...
\todo[inline]{Check validity of each story.}
\todo[inline]{Check validity of each test.}
\todo[inline]{Check duration of each story.}
\todo[inline]{Allocate actual duration to each story.}
...
\todo[inline]{Consider making this section an appendix.}
\bigskip
