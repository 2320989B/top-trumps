...
\end{center}
\begin{center}
	\includegraphics[scale=0.4]{S0250_MultipleGames.jpg}
	\captionof{figure}{Multiple games can exist simultaneously in different tabs with game index.}
\end{center}
\begin{center}
	\includegraphics[scale=0.5]{onlineTesting.png}
...
\end{center}
\begin{center}
	\includegraphics[scale=0.3]{onlineTesting_2.png}
